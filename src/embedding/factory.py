...
from embedding.cxtebd_new import CXTEBDNEW
from embedding.cxtebd_tars import CXTEBDTARS
...
def get_embedding(vocab, args):
    ...
    elif args.embedding == 'ebdnew':
        model = CXTEBDNEW(args)
    elif args.embedding == 'ebdtars':
        model = CXTEBDTARS(args)
